        ...
        $('#form_1_proceed').click(function() {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    var eligibleText = `<h3 class="text-center"><strong>You are eligible to apply for  a U.S. Entry Waiver & Canadian Record Suspension (Pardon)</strong></h3>`;
