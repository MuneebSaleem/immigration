        ...
        <div class="container">
            <div class="row">
                <div class="col-9 col-md-6 col-xl-4">
                    <img class="navbar-brand" src="{{asset('app-logo/BridgeSealHeader.webp')}}" alt="US Immigration support">
                    ...
                    <div class="col-xs-12 text-justify accept-box form-group required" data-fieldname="accept" aria-required="true">
                        <div class="checkbox" id="id_step1-accept">
                            <label for="id_step1-accept_0">
                                ...
                                I have read and consent to the <a  type="button" href="#privacy" data-bs-toggle="modal" data-bs-target="#privacy" id="privacylModal">Privacy Policy</a> and <a  type="button" href="#terms" data-bs-toggle="modal" data-bs-target="#terms" id="termModal">Terms & Conditions </a> of this website. I am of legal age, or have parental/guardian consent.<b> Price: $9.99 CAD</b>
                            </label>
                        </div>
